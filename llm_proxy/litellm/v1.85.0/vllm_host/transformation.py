# /litellm/litellm/llms/hosted_vllm/chat/transformation.py
...
class HostedVLLMChatConfig(OpenAIGPTConfig):
    def _convert_custom_tools_to_function_tools(
        ...
        Convert custom/namespace tools into function tools so request validation does not fail.
        """
        ...
        for idx, tool in enumerate(tools):
            ...
            if tool.get("type") == "namespace":
                # Codex 0.135.0+ wraps MCP server tools as a namespace.
                # Expand each nested function tool into a flat function tool
                # with name "{namespace}__{tool_name}".
                ...
                for nested_tool in tool.get("tools") or []:
                    ...
                    if nested_tool.get("type") != "function":
                        continue
                    tool_name = nested_tool.get("name") or f"tool_{idx}"
                    qualified_name = (
                    ...
                    description = nested_tool.get("description")
